<template lang="">
  <div>
    ...
    <el-table class="tablist" type="expand" @current-change="handleSelectionChange" max-height="650" :data="tableData"
      style="width: 100%">
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <el-form-item label="错误信息">
              <span>{{ props.row.e_details }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="e_number" label="默认编码"  width="85"> </el-table-column>
      <el-table-column label="实时时间">
      ...
      <el-table-column prop="e_qq" label="QQ">
      </el-table-column>
      <el-table-column prop="e_version" label="Q版本"> </el-table-column>
